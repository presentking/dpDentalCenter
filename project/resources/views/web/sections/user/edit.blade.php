...
@endif
    <div class="max-w-4xl flex mx-auto">
            ...
            <div class="max-w-sm rounded overflow-hidden shadow-lg my-3 mx-2 max-h-15 ">
                <img class="w-full" src="{{ asset("storage/img/$doctor->path_img") }}" alt="Sunset in the mountains">
                <div class="px-6 py-4">
                    <div class="font-bold text-xl mb-2">{{ $doctor->last_name }} {{ $doctor->first_name }}
                        {{ $doctor->father_name }}</div>
                    ...
                    <p class="text-gray-700 text-base">
                        Специализация:
                        @foreach($doctor->specializations as $it)
                            @if($loop->last)
                                {{$it->name}}.
                            @else
                                {{$it->name}},
                        ...
                        <button type="button" data-ripple-light="true" data-dialog-target="UpdateDialog{{$doctor->id}}" class="text-purple-700 hover:text-white border border-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-purple-400 dark:text-purple-400 dark:hover:text-white dark:hover:bg-purple-500 dark:focus:ring-purple-900">Добавить специализацию</button>
                    {{--INSERT SPEC MODAL!--}}
                    <div data-dialog-backdrop="UpdateDialog{{$doctor->id}}" data-dialog-backdrop-close="true" class="pointer-events-none fixed inset-0 z-[999] grid h-screen w-screen place-items-center bg-black bg-opacity-60 opacity-0 backdrop-blur-sm transition-opacity duration-300">
                        <div data-dialog="UpdateDialog{{$doctor->id}}" class="relative m-4 w-2/5 min-w-[40%] max-w-[40%] rounded-lg bg-white font-sans text-base font-light leading-relaxed text-blue-gray-500 antialiased shadow-2xl">
                            <div class="flex items-center p-4 font-sans text-2xl antialiased font-semibold leading-snug shrink-0 text-blue-gray-900">
                            ...
                            <div class="relative p-4 font-sans text-base antialiased font-light leading-relaxed border-t border-b border-t-blue-gray-100 border-b-blue-gray-100 text-blue-gray-500">
                                <form class="max-w-sm mx-auto" action="{{route('user.storeSpec', $doctor->id)}}" method="POST">
                                    @csrf
                                    <div class="mb-5">
                                        <input type="text"  id="user_id" name="user_id" value="{{$doctor->id}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 hidden"/>
                    ...
                    <button type="button" data-ripple-light="true" data-dialog-target="DeleteDialog{{$doctor->id}}" class="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">Удалить специализацию</button>
                    {{--DELETE MODAL!--}}
                    <div data-dialog-backdrop="DeleteDialog{{$doctor->id}}" data-dialog-backdrop-close="true" class="pointer-events-none fixed inset-0 z-[999] grid h-screen w-screen place-items-center bg-black bg-opacity-60 opacity-0 backdrop-blur-sm transition-opacity duration-300">
                        <div data-dialog="DeleteDialog{{$doctor->id}}" class="relative m-4 w-2/5 min-w-[40%] max-w-[40%] rounded-lg bg-white font-sans text-base font-light leading-relaxed text-blue-gray-500 antialiased shadow-2xl">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <form action="{{route('user.delete', $doctor->id)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Выберите специализацию врача которую хотите удалить</h3>
                                        <input type="text"  id="user_id" name="user_id" value="{{$doctor->id}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 hidden"/>
                                        ...
                                        <button type="submit" data-ripple-light="true" data-dialog-close="true" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">Удалить</button>
                                    </div>
                                </form>
                            </div>
                        </div>
            ...
            <form class="max-w-sm mx-auto" action="{{route('user.update', $doctor->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-2">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" id="last_name" name="last_name" value="{{$doctor->last_name}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                </div>
                @error('last_name')
                <div class="text-sm text-red-600">{{ $message }}</div>
                @enderror
                <div class="mb-2">
                    ...
                    <input type="text" id="first_name" name="first_name" value="{{$doctor->first_name}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                </div>
                @error('first_name')
                <div class="text-sm text-red-600">{{ $message }}</div>
                @enderror
                <div class="mb-2">
                    ...
                    <input type="text" id="father_name" name="father_name" value="{{$doctor->father_name}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                </div>
                @error('father_name')
                <div class="text-sm text-red-600">{{ $message }}</div>
                @enderror
                <div class="mb-2">
                    ...
                    <input type="number" id="number_phone" name="number_phone" value="{{$doctor->number_phone}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                </div>
                @error('number_phone')
                <div class="text-sm text-red-600">{{ $message }}</div>
                @enderror
                ...
                <div class="mb-2">
                    <div class="mb-2">
                        <label for="number_phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Дата рождения</label>
                        <input type="date" id="date_of_birth" name="date_of_birth" value="{{$doctor->date_of_birth}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="yyyy.mm.dd" required />
                    </div>
                </div>
                @error('date_of_birth')
                <div class="text-sm text-red-600">{{ $message }}</div>
                ...
                <div class="mb-2">
                    ...
                    <input type="text" id="residence_address" name="residence_address" value="{{$doctor->residence_address}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                </div>
